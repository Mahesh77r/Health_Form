...
const Summary: React.FC = () => {
  ...
  const [lifestyleData, setLifestyleData] = useState<LifestyleData | null>(
    null
  );
  const [sexualHealth, setSexualHealth] = useState<SexualHealth | null>(null);
  const [erectionIssues, setErectionIssues] = useState<ErectionIssues | null>(
    null
  );
  const [ejaculationIssues, setEjaculationIssues] =
    useState<EjaculationIssues | null>(null);
  ...
  const getSummaryData = async () => {
    try {
      ...
      if (data) {
        ...
        setMedicalHistory({
          diagnosedConditions:
            data.MedicalhistoryData.diagnosedConditions || [],
        ...
        setLifestyleData({
          ...
          smokingfrq:
            data.LifestyleHabitsData.smokeTobaccoFrequency || "Not Mentioned",
          ...
          physicalActivityDetails:
            data.LifestyleHabitsData.physicalActivityDetails || "",
        ...
        setSexualHealth({
          ...
          femaleConcerns:
            data.RelationshipSexualHealthData.femaleConcerns || [],
          relationshipStatus:
            data.RelationshipSexualHealthData.relationshipStatus,
        ...
        setErectionIssues({
          ...
          erectionIssuesDuringMasturbation:
            data.ErectionIssueData.erectionIssuesDuringMasturbation,
          hadOtherSexualPartners: data.ErectionIssueData.hadOtherSexualPartners,
          similarErectionProblemsWithPastPartners:
            data.ErectionIssueData.similarErectionProblemsWithPastPartners,
        });
        ...
        setEjaculationIssues({
          ...
          similarEjaculationDuringMasturbation:
            data.EjaculationIssueData.similarEjaculationDuringMasturbation,
          hadOtherSexualPartners:
            data.EjaculationIssueData.hadOtherSexualPartners,
          similarTimingProblemWithPastPartners:
            data.EjaculationIssueData.similarTimingProblemWithPastPartners,
        });
        ...
        setStressData({
          ...
          relationshipWithPartner:
            data.StressSurveyData.relationshipWithPartner,
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <section className="bg-white shadow-md rounded-lg p-6 mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-4 border-b-2 pb-2">
          Patient Information
        </h2>
        <div className="grid grid-cols-2 gap-4">
          ...
          <p>
            <span className="font-semibold">City:</span> {patientInfo?.city}
          </p>
          <p>
      ...
      <section className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <p>
            <span className="font-semibold">Frequency of Smoking:</span>{" "}
            {lifestyleData?.smokingfrq}
          </p>
          <p>
            <span className="font-semibold">Consume Alcohol:</span>{" "}
            {lifestyleData?.consumeAlcohol}
          </p>
          <p>
            <span className="font-semibold">
              Frequency of Consuming Alcohol:
            </span>{" "}
            {lifestyleData?.alcoholFrequency}
          </p>
          <p>
            <span className="font-semibold">Physcial Activity:</span>{" "}
            {lifestyleData?.physicalActivity}
          </p>
          <p>
            <span className="font-semibold">Physcial Activity Details:</span>{" "}
            {lifestyleData?.physicalActivityDetails}
          </p>
          <p>
            <span className="font-semibold">Avarage Sleep Hours:</span>{" "}
            {lifestyleData?.averageSleepHours}
          </p>
        </div>
      </section>
      ...
      <section className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        {medicalHistory?.otherChronicIllness && (
          <p>
            <span className="font-semibold">Other Chronic Illness:</span>{" "}
            {medicalHistory?.otherChronicIllness}
          </p>
        )}
        <p>
          <span className="font-semibold">Taking Medications:</span>{" "}
          {medicalHistory?.takingMedications}
        </p>
        {medicalHistory?.medicationsList && (
          <p>
            <span className="font-semibold">Medications List:</span>{" "}
            {medicalHistory?.medicationsList}
          </p>
        )}
        <p>
          <span className="font-semibold">Had Surgeries:</span>{" "}
          {medicalHistory?.hadSurgeries}
        </p>
        {medicalHistory?.pastSurgeriesDetails && (
          <p>
            <span className="font-semibold">Past Surgeries Details:</span>{" "}
            {medicalHistory?.pastSurgeriesDetails}
          </p>
        )}
      </section>
      ...
      <section className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <p>
          ...
          {sexualHealth?.relationshipStatus}
        </p>
        <p>
          <span className="font-semibold">Sexually Active:</span>{" "}
      ...
      <section className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <p>
            <span className="font-semibold">Issue Duration:</span>{" "}
            {erectionIssues?.issueDuration}
          </p>
          <p>
            <span className="font-semibold">Masturbate Regularly:</span>{" "}
            {erectionIssues?.masturbateRegularly}
          </p>
          {erectionIssues?.masturbationFrequency && (
            <p>
              <span className="font-semibold">Masturbation Frequency:</span>{" "}
              {erectionIssues?.masturbationFrequency} times/week
            </p>
          )}
          {erectionIssues?.erectionIssuesDuringMasturbation && (
            <p>
              <span className="font-semibold">
                Erection Issues During Masturbation:
              </span>{" "}
              {erectionIssues?.erectionIssuesDuringMasturbation}
            </p>
          )}
          <p>
            <span className="font-semibold">Had Other Sexual Partners:</span>{" "}
            {erectionIssues?.hadOtherSexualPartners}
          </p>
          {erectionIssues?.similarErectionProblemsWithPastPartners && (
            <p>
              <span className="font-semibold">
                Similar Problems With Past Partners:
              </span>{" "}
              {erectionIssues?.similarErectionProblemsWithPastPartners}
            </p>
          )}
      ...
      <section className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <p>
            <span className="font-semibold">Ejaculation Time:</span>{" "}
            {ejaculationIssues?.ejaculationTime}
          </p>
          <p>
            <span className="font-semibold">Issue Duration:</span>{" "}
            {ejaculationIssues?.issueDuration}
          </p>
          <p>
            <span className="font-semibold">Masturbate Regularly:</span>{" "}
            {ejaculationIssues?.masturbateRegularly}
          </p>
          {ejaculationIssues?.similarEjaculationDuringMasturbation && (
            <p>
              <span className="font-semibold">
                Similar Ejaculation During Masturbation:
              </span>{" "}
              {ejaculationIssues?.similarEjaculationDuringMasturbation}
            </p>
          )}
          <p>
            <span className="font-semibold">Had Other Sexual Partners:</span>{" "}
            {ejaculationIssues?.hadOtherSexualPartners}
          </p>
          {ejaculationIssues?.similarTimingProblemWithPastPartners && (
            <p>
              <span className="font-semibold">
                Similar Timing Problems in the Past:
              </span>{" "}
              {ejaculationIssues?.similarTimingProblemWithPastPartners}
            </p>
          )}
      ...
      <section className="bg-white shadow-md rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <p>
            <span className="font-semibold">Stress Level (1-10):</span>{" "}
            {stressData?.stressLevel}
          </p>
          <p>
            <span className="font-semibold">Significant Life Changes:</span>{" "}
            {stressData?.significantLifeChange}
          </p>
          ...
          <p>
            <span className="font-semibold">Relationship With Partner:</span>{" "}
            {stressData?.relationshipWithPartner}
          </p>
